...
class ResourcePaths:
    ...
    def get_temp_path(self, epub_file: Path) -> Path:
        """
    ...
    def get_path_to_resource(self, resource_name: str) -> Path:
        """
    ...
    def generate_destination_file_name(self, source_file: Path) -> str:
        """
...
RESOURCE_PATHS_SINGLETON = ResourcePaths()
