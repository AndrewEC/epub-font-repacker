...
class JoiningPaths:
    ...
    def get_relative_joining_path(self, temp_path: Path, child_path: Path) -> str:
        """
    ...
    def get_relative_joining_path_to_manifest(self, temp_path: Path) -> str:
        """
        ...
        """
        opf_file_path = self._opf.find_path_to_opf_file(temp_path)
        return self.get_relative_joining_path(temp_path, opf_file_path)


JOINING_PATHS_SINGLETON = JoiningPaths()
